...
bool operator!=(glm::vec2 const& vec1, ImVec2 const& vec2) { return vec1.x != vec2.x || vec1.y != vec2.y; }
...
{
    switch (gizmoType) {
    case TerranEditor::GizmoType::None:
        return (ImGuizmo::OPERATION)0;
    case TerranEditor::GizmoType::Translaste:
        return ImGuizmo::TRANSLATE;
    case TerranEditor::GizmoType::Rotate:
        return ImGuizmo::ROTATE;
    case TerranEditor::GizmoType::Scale:
...
void SceneViewPanel::OnRender()
{
    ...
    Terran::Core::Shared<Framebuffer> framebuffer = m_SceneRenderer->GetFramebuffer();
    ...
    Terran::Core::Shared<Texture2D> colorAttachment = framebuffer->GetColorAttachment(0);
    ...
    if (ImGui::BeginDragDropTarget()) {
        if (ImGuiPayload const* payload = ImGui::AcceptDragDropPayload("ASSET")) {
            ...
            AssetInfo sceneAssetInfo = AssetManager::GetAssetInfoByHandle(id);
...
void SceneViewPanel::OnEvent(Terran::Core::Event& event)
{
...
bool SceneViewPanel::OnKeyPressed(KeyPressedEvent& e)
{
    ...
    case Key::Q:
        ...
        break;
    case Key::W:
        m_GizmoType = GizmoType::Translaste;
        break;
    case Key::E:
...
void SceneViewPanel::DrawGizmos(glm::mat4 const& projectionMatrix, glm::mat4 const& viewMatrix)
{
