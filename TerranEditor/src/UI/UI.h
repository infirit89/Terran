...
namespace TerranEditor::UI
{
	...
	bool PropertyScriptArrayField(const TerranEngine::Shared<TerranEngine::Scene>& scene, ScriptArray& array, const TerranEngine::Shared<TerranEngine::ScriptInstance>& scriptInstance);
