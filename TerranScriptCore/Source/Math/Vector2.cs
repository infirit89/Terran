...
namespace Terran
{
	...
	public struct Vector2 : IEquatable<Vector2>
	{
		...
		public static Vector2 Add(Vector2 vec1, Vector2 vec2) => new(vec1.X + vec2.X, vec1.Y + vec2.Y);
		
		public static Vector2 Subtract(Vector2 vec1, Vector2 vec2) => new(vec1.X - vec2.X, vec1.Y - vec2.Y);

		public static Vector2 Multiply(Vector2 vec1, Vector2 vec2) => new(vec1.X * vec2.X, vec1.Y * vec2.Y);
		public static Vector2 Multiply(Vector2 vec1, float scalar) => new(vec1.X * scalar, vec1.Y * scalar);
		public static Vector2 Multiply(Vector2 vec1, int scalar) => new(vec1.X * scalar, vec1.Y * scalar);

		public static Vector2 Divide(Vector2 vec1, Vector2 vec2) => new(vec1.X / vec2.X, vec1.Y / vec2.Y);
		public static Vector2 Divide(Vector2 vec1, float scalar) => new(vec1.X / scalar, vec1.Y / scalar);
		public static Vector2 Divide(Vector2 vec1, int scalar) => new(vec1.X / scalar, vec1.Y / scalar);
		...
		public static implicit operator Vector2(Vector3 vec) => new(vec);
