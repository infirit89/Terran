...
namespace TerranScriptCore
{
    public class Log
    {
        ...
        public static void Trace(string message) => Log_Internal((byte)LogLevel.Trace, message != null ? message : "");
        ...
        public static void Warn(string message) => Log_Internal((byte)LogLevel.Warn, message != null ? message : "");
        ...
        public static void Error(string message) => Log_Internal((byte)LogLevel.Error, message != null ? message : "");
        ...
        static extern void Log_Internal(byte level, string text);
    }
}
