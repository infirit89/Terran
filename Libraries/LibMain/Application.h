...
private:
    ...
    static Application* m_Instance;           ///< Singleton instance pointer
    Terran::Core::LayerStack m_Stack;         ///< Stack of application layers
    
    bool m_Minimized = false;                 ///< Window minimization state
    bool m_Running = false;                   ///< Application running state

    friend int ::main(int argc, char** argv); ///< Allows main() to access run()
};
