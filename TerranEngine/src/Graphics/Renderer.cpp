...
void Renderer::Initialize()
{
    ...
    s_RendererData->CreateResourceQueue = Terran::Core::CreateShared<CommandQueue>();
    s_RendererData->RenderQueue = Terran::Core::CreateShared<CommandQueue>();
    s_RendererData->FreeResourceQueue = Terran::Core::CreateShared<CommandQueue>();
...
void Renderer::DrawIndexed(RenderMode mode, Terran::Core::Shared<VertexArray> const& vertexArray, int numIndices)
{
    vertexArray->Bind();
...
void Renderer::DrawArrays(RenderMode mode, Terran::Core::Shared<VertexArray> const& vertexArray, int numVertices)
{
    vertexArray->Bind();
...
void Renderer::DrawInstanced(RenderMode mode, Terran::Core::Shared<VertexArray> const& vertexArray, int instanceCount)
{
    vertexArray->Bind();
