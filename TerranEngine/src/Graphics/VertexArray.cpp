...
void VertexArray::AddVertexBuffer(Terran::Core::Shared<VertexBuffer> const& buffer)
{
...
void VertexArray::AddIndexBuffer(Terran::Core::Shared<IndexBuffer> const& buffer)
{
