...
void PhysicsBody2D::SetPosition(glm::vec2 const& position)
{
    TR_ASSERT(m_Body, "Physics Body is null");
...
void PhysicsBody2D::SetLinearVelocity(glm::vec2 const& linearVelocity)
{
    TR_ASSERT(m_Body, "Physics Body is null");
...
void PhysicsBody2D::ApplyForce(glm::vec2 const& force, glm::vec2 const& point, ForceMode2D forceMode)
{
    TR_ASSERT(m_Body, "Physics Body is null");
...
void PhysicsBody2D::ApplyForceAtCenter(glm::vec2 const& force, ForceMode2D forceMode)
{
    TR_ASSERT(m_Body, "Physics Body is null");
...
void PhysicsBody2D::RemoveCollider(int index)
{
    ...
    Terran::Core::Shared<Collider2D> collider = m_Colliders.at(index);
