...
void SetFixtureDefMaterial(b2FixtureDef& fixtureDef, Terran::Core::Shared<PhysicsMaterial2D> const& material)
{
...
Collider2D::Collider2D(ColliderType2D colliderType, size_t fixtureArraySize)
    : p_FixtureArraySize(fixtureArraySize)
...
Terran::Core::Shared<PhysicsBody2D> Collider2D::GetPhysicsBody() const
{
    TR_ASSERT(p_Fixtures, "Fixture is null");
    ...
    : Collider2D(ColliderType2D::Box)
{
    ...
    Terran::Core::Shared<PhysicsMaterial2D> material = AssetManager::GetAssetByHandle<PhysicsMaterial2D>(rigidbodyComponent.PhysicsMaterialHandle);
...
void BoxCollider2D::SetSize(glm::vec2 const& size)
{
...
void BoxCollider2D::SetOffset(glm::vec2 const& offset)
{
    TR_ASSERT(m_PolygonShape, "Shape is null");
...
void CircleCollider2D::SetOffset(glm::vec2 const& offset)
{
    TR_ASSERT(m_CircleShape, "Shape is null");
...
// TODO: implement
void CapsuleCollider2D::SetSize(glm::vec2 const& size)
{
...
void CapsuleCollider2D::SetOffset(glm::vec2 const& offset)
{
    TR_ASSERT(m_LowerCircleShape && m_UpperCircleShape && m_BoxShape, "Shapes are null");
